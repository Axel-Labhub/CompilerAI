  ...
  return (
    <aside className="w-56 bg-app-card border-r border-app-border flex flex-col h-full">
      ...
      <div className="p-4">
        <button
          onClick={onNewNote}
          className="w-full py-2.5 px-4 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-medium transition-all duration-200 hover:shadow-lg hover:shadow-primary-500/30 hover:-translate-y-0.5 active:scale-[0.98] flex items-center justify-center gap-2"
        >
      ...
      <nav className="flex-1 overflow-y-auto px-2">
        ...
        <button
          ...
          className={`w-full px-3 py-2 rounded-lg text-left text-sm flex items-center gap-2 mb-1 transition-all duration-200 hover:-translate-y-0.5 ${
            activeTag === null
              ? 'bg-primary-500/20 text-primary-400'
              : 'text-app-text hover:bg-app-border/50 hover:shadow-sm'
          }`}
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {favoriteCount > 0 && (
          <button
            ...
            className="w-full px-3 py-2 rounded-lg text-left text-sm text-app-text hover:bg-app-border/50 flex items-center gap-2 mb-1 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm"
          >
        ...
        <button
          ...
          className="w-full px-3 py-2 rounded-lg text-left text-sm text-app-text hover:bg-app-border/50 flex items-center gap-2 mb-3 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm"
        >
        ...
        <button
          onClick={onShowFavorites ? () => {
            // 通过特殊标记触发示例笔记
            const event = new CustomEvent('showSampleNotes')
