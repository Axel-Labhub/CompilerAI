...
export const AIProcessingIndicator: React.FC = () => {
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-primary-500/10 rounded-lg">
      ...
      <span className="text-sm text-primary-400">AI 处理中...</span>
      <div className="flex gap-0.5">
        <span className="w-1 h-4 bg-primary-400 rounded animate-bounce" style={{ animationDelay: '0ms' }} />
        <span className="w-1 h-4 bg-primary-400 rounded animate-bounce" style={{ animationDelay: '150ms' }} />
        <span className="w-1 h-4 bg-primary-400 rounded animate-bounce" style={{ animationDelay: '300ms' }} />
      </div>
    </div>
  )
}
