...
- 一句话概括本周整体工作
- 包含关键数据和亮点
- 格式："本周围绕XX目标，完成XX，关键进展XX"

### 2. 本周重点（3-5条）
- 每条一行，简洁有力
- 按重要程度排序
- 使用动词开头（完成、推进、解决、交付、上线）
- 格式："[动词] + [具体内容] + [结果/数据]"
...
## 输出格式（必须是有效JSON）
{
  ...
  "summary": "本周工作概述（1-2句话，包含关键数据）",
  "highlights": ["重点1 - 包含数字和动词", "重点2", "重点3"],
  "achievements": ["成果1 - 量化数据", "成果2"],
  "problems": ["问题 → 原因 → 解决方案"],
  "nextWeek": ["计划1 - 目标 - 时间", "计划2 - 目标 - 时间"]
}
